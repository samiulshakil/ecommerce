...
<div class="container">
 ...
 <!-- {{ Form::open(['route'=>'new-brand'], ['action'=>'POST'], ['class'=>'form-horizontal '] ) }} -->
  		  ...
  		  <form class="form-horizontal" action="{{route('new-brand')}}" method="post" id="testValid">

  		  	{{ csrf_field() }}
		    <div class="form-group {{ $errors->has('brand_name') ? ' has-error' : '' }}">
		      <label class="control-label col-sm-2" for="name">Brand Name:</label>
		      <div class="col-sm-10">
		        <input type="text" class="form-control" id="email" placeholder="Enter Brand Name" name="brand_name">
