...
@section('title')
This home page of ecommerce shop
@endsection
						...
						<div class="arrivals-grids">
							...
							<div class="col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
												<div class="grid-img">
													<img  src="{{ asset($product->product_image) }}" class="img-responsive" alt="" width="100%" height="300px">
												</div>
												<div class="grid-img">
													<img  src="{{ asset($product->product_image) }}" class="img-responsive"  alt="" height="200px" width="200px">
												</div>			
											</a>		
										</figure>	
									</div>
									...
									<div class="women">
										<h6><a href="{{route('product-details', ['id'=>$product->id, 'name'=> $product->product_name])}}">{{$product->product_name}}</a></h6>
										<span class="size">XL / XXL / S </span>
										<p ><del></del><em class="item_price">${{$product->product_price}}</em></p>
